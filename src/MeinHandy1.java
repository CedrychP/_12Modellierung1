public class MeinHandy1 {
  // Membervariablen
  public int speicher;
  public int sprechzeit;
  public int standbyzeit;
  public int bildschirmAufloesungX;
  public int bildschirmAufloesungY;

  // Konstruktor
  public MeinHandy1(int speicher, int sprechzeit, int standbyzeit, int x, int y) {
